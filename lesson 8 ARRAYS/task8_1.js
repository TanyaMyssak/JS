...
const numbers = [2, -5, 0, -0, -3, 0, 10, -8];
let positiveCount = 0;
let negativeCount = 0;
let zeroCount = 0;
...
console.log("NO of positive numbers:", positiveCount);
console.log("NO of negative numbers:", negativeCount);
console.log("NO of nulls:           ", zeroCount); 